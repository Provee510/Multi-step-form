      ...
      <div className="h-[150vh] bg-blue-100 flex items-center justify-center text-white p-5">
        <div className="inner bg-white h-[550px] w-[400px] md:w-[700px] md:h-[700px] rounded-xl relative bottom-[95px] md:bottom-[160px] p-4">
         ...
         <div className="select text-slate-700 py-3">
          ...
          <div className="op  h-[80px] border border-gray-400 rounded-xl bg-blue-100 p-5 space-y-7 pt-4">
           <div className="count ">
           <div className="img flex  gap-4">
            ...
            <div className="text-gray-500">$9/mo
           </div>
           </div>
           </div>
           </div>
          </div>
          <div className="op  h-[80px]  border border-gray-400 rounded-xl p-5 space-y-7 pt-4">
           <div className="count ">
           <div className="img flex  gap-4">
            <img src={advanced} alt="" className="h-12 w-12"/>
            <div className="img-text relative bottom-1">
            <div className="text-xl text-gray-600 font-semibold">Advanced</div>
            <div className="text-gray-500">$12/mo
           </div>
           </div>
           </div>
           </div>
          ...
          <div className="op  h-[80px] border border-gray-400 rounded-xl p-5 space-y-7 pt-4">
           ...
           <div className="img flex  gap-4">
            ...
            <div className="text-gray-500">$15/mo
           </div>
           </div>
           </div>
           </div>
